        ...
        <td><table width="780"  border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
			...
			<table width="100%"  border="0" cellspacing="0" cellpadding="0">
			  ...
			  <?php
			  	$cat_list_sql = "select * from tbl_category order by cat_name asc";
				$cat_list_result = mysql_query($cat_list_sql) or die(mysql_error());
				while ($cat_list_row = mysql_fetch_array($cat_list_result))
				{
			  ?>
              <tr>
                <td class="MainMenuSelected"><?=$cat_list_row['cat_name']?></td>
              </tr>
              <tr>
                <td class="smallblack"><?=$cat_list_row['description']?></td>
              </tr>
              <tr>
                <td height="20" align="right" class="smallred"><a href="product_category.php?category_id=<?=$cat_list_row['category_id']?>">&laquo; goto products list</a></td>
              </tr>
              <tr>
