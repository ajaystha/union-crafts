  ...
  <tr>
	...
	<form name="addform" method="post" action="<?php print $_SERVER['PHP_SELF'];?>">
        <table border="0" cellspacing="0" cellpadding="3" align="center">
          <tr class="smallblack">
            <td colspan="2" class="mediumtext"><strong> Add FAQ</strong></td>
          </tr>
          <tr class="smallblack">
            <td align="right" valign="top" class="cellbgbl formText">News posted on :</td>
            <td><input name="date" type="text" class="smallblack" id="date" value="" size="30"></td>
          </tr>
          <tr class="smallblack">
            <td align="right" valign="top" class="cellbgbl formText"> NEWS in detail :</td>
            <td class="smalltext"><textarea name='news' cols='50' rows='15' class="smallblack" id="news"></textarea>
		...
		else
		{
			...
			$query="INSERT INTO tbl_news (news_posted_on, news_in_detail) VALUES('$date', '$news')";
		...
		?>
			<table width="100%" border="0" cellspacing="0" cellpadding="3" align="center">
				<tr>
					<td colspan="2" align="center" class="mediumtext"><strong>Add NEWS</strong></td>
				</tr>
				  <tr>
					<td colspan="2" align="center" class="smallblack"><font color="#FF0000" face="Arial, Helvetica, sans-serif"><b>Successfully added NEWS</b></font></td>
				  </tr>
				  <tr>
					<td colspan="2" align="center" class="smallblack"><a href="add_news.php" class="arl9">Go Back to another NEWS.</a></td>
				  </tr>
			</table>
		<?php
				}
