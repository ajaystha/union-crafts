  ...
  <tr>
	...
	<form name="addform" method="post" action="<?php print $_SERVER['PHP_SELF'];?>">
        <table border="0" cellspacing="0" cellpadding="3" align="center">
          <tr class="smalltext">
            <td colspan="2" class="pophead"> <strong>Add FAQ</strong></td>
          </tr>
          <tr class="smalltext">
            <td align="right" class="cellbgbl formText">Question :</td>
            <td><input name="question" type="text" class="smallblack" size="60"></td>
          </tr>
          <tr class="smalltext">
		...
		?>
			<table width="100%" border="0" cellspacing="0" cellpadding="3" align="center">
				<tr>
					<td colspan="2" align="center" class="smalltext">Add FAQ</td>
				</tr>
				  <tr>
					<td colspan="2" align="center" class="smalltext"><font color="#FF0000" face="Arial, Helvetica, sans-serif"><b>Successfully added FAQ</b></font></td>
				  </tr>
				  <tr>
					<td colspan="2" align="center" class="smalltext"><a href="add_faq.php" class="arl9">Go Back to another FAQ</a></td>
				  </tr>
			</table>
		<?php
				}
