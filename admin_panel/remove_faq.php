	...
	if (isset($submit))
	{
		...
		while($x < $total_records_deleted)
		{
			...
			else
			{
				...
				print "<font color=#FF0000><p>FAQ ".$array[$x]." has been deleted successfully.<br>";
			}
			$x++;
		}
	}
...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<table width="98%" border="0" cellspacing="0" cellpadding="2" align="center">
       <tr>
         <td class="linktext"><strong>Delete FAQ</strong></td>
       </tr>         
       <tr>
		...
		<td class="smallblack">
			...
			<?php
				...
				while($row = mysql_fetch_array($faq_result))
				{
					...
					print '<td class=smallblack valign=top>'.$row[question].'</td>';				
					print '<td width=10><input type=checkbox name=array[] value='.$row[faq_id].'></td>';
					print '</tr>';
					$i++;
				}
			?>
