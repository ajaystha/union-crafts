    ...
    <td><table width="100%"  border="0" cellpadding="0" cellspacing="0">
      <tr>
            ...
            <td>
              <table width="100%"  border="0">
                <tr align="center" class="goldbg">
                  ...
                  <td><span class="formText">Show in</span></td>
                  <td><span class="formText">Date</span></td>
                  <td><span class="formText">Options</span></td>
                </tr>
                <?php
			  	$a_sql = "select * from tbl_vehicle where approve='0'";
				$a_result = mysql_query($a_sql) or die(mysql_error());
				if (mysql_num_rows($a_result) <= 0)
				{
					print "<tr><td colspan=5><font color=red>No vehicles to be approved.</font></td></tr>";
				}
				$i = 1;
			  ...
			  ?>
				...
				<tr align="center" valign="top" bgcolor="<?=$bgColor?>">
                  <td align="center"><?=$i?><input name="action" type="hidden" id="action" value="approve">
                    <input name="vid" type="hidden" id="vid" value="<?=$a_row[vid]?>"></td>
        ...
        <?=$a_row[make]?>
                    ...
                    <p align="center"><font color="#FF0000">[ <a href="javascript: goTo(<?=$a_row[vid]?>)"><font color="#FF0000">edit</font></a> ]</font></p></td>
                  <td align="center">
                    <?php
						$mem_id = $a_row[mem_id];
                  ...
                  <td align="left">
				  <input name="show_new" type="checkbox" id="show_new" value="yes" <?php if ($a_row[show_new]=='yes') print 'checked';?>>
                    New<br>
                    <input name="used" type="checkbox" id="used" value="yes" <?php if ($a_row[show_used]=='yes') print 'checked';?>>
                    Used<br>
                    <input name="sale" type="checkbox" id="sale" value="yes" <?php if ($a_row[show_sell]=='yes') print 'checked';?>>
                    Sale</td>
                  <td align="center">
                    <?php
                  ...
                  <td align="center"><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td><a href="javascript: submitform<?=$i?>()">Approve</a></td>
                        <td><a href="../cms/<?php print $_SERVER['PHP_SELF'];?>?vid=<?=$a_row[vid]?>&action=del">Delete</a></td>
                      </tr>
                  </table></td>
                </tr>
