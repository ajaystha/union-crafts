...
<?php
	...
	// print "here|";
	$p_sql = "select * from tbl_showcase where prod_key='$product_id'";
	// print $p_sql;
                ...
                <td valign="top"><table width="98%"  border="0" align="center" cellpadding="2" cellspacing="0">
                  ...
                  <tr>
                    <td><table width="100%"  border="0" cellspacing="1" cellpadding="2">
                      <tr>
                        <td><img src="library/showcase/enlarge/<?=$p_rs['prod_key']?>.jpg" alt="<?=$p_rs['product_name']?>" class="txtbox_1"></td>
                  ...
                  <tr>
                    <td class="mediumred"><strong>Quick Contact for the above antique </strong></td>
                  </tr>
                  <tr>
