			...
			<table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td height="30" class="smenu">Payment information </td>
                  </tr>
                  <tr>
                    <td>
                  ...
                  <tr>
                    <td height="20" class="smallblack">Here are the details for payment. </td>
                  </tr>
                </table></td>
              </tr>
              <tr>
              ...
              <tr bgcolor="#F2F2F2">
                <td height="10" bgcolor="#FFFFFF" class="smallblack"><div align="center">
                  <table width="80%"  border="0" cellspacing="1" cellpadding="5">
                    <tr>
                      <td><div align="center"><strong class="mediumtext">Benefeciary: 
                        UNION CRAFTS </strong><br>
                          <span class="mediumred">Bank Account # 01-01-0006117-1<br>
                          <span class="mediumdarkgrey">Banker : Bank of Kathmandu</span><br>
  Swift Code: BOKLNPKA <br>
  </span><span class="smalldarkgrey">Bank address: Thamel, Kathmandu, Nepal. </span> </div></td>
                    </tr>
                  </table>
                  </div></td>
              </tr>
